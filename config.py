...
class Config(object):
    SECRET_KEY=os.environ.get('SECRET_KEY') or 'sunyuedewangzhan'#Flask-WTF密钥
...
class ProdConfig(object):
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL') or u"mysql://web:web@localhost/r"
